...
<div class="row mb-4">
    <div class="col-12 d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('admin.users.create') }}" class="btn btn-danger" style="background-color: var(--primary-color);">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{ route('admin.users.edit', $user) }}" class="btn btn-sm btn-info text-white me-1" title="Edit"><i class="fas fa-edit"></i></a>
