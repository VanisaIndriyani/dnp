...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted mb-0">Unduh dan kelola laporan aktivitas sistem.</p>
    </div>
</div>
        ...
        <div class="card h-100 border-0 shadow-sm hover-lift overflow-hidden">
            <div class="card-body p-4 position-relative">
                ...
                <div class="d-grid gap-2">
                    <a href="{{ route('admin.attendance.export') }}" class="btn btn-success py-2 fw-medium">
                        <i class="fas fa-file-excel me-2"></i>Download Excel
                    </a>
                    <a href="{{ route('admin.attendance.index') }}" class="btn btn-outline-secondary py-2">
    ...
    <div class="col-md-6">
        <div class="card h-100 border-0 shadow-sm hover-lift overflow-hidden">
            <div class="card-body p-4 position-relative">
                ...
                <div class="d-grid gap-2">
                    <a href="{{ route('admin.evaluation.results.export') }}" class="btn btn-success py-2 fw-medium">
                        <i class="fas fa-file-excel me-2"></i>Download Excel
                    </a>
                    <a href="{{ route('admin.evaluation.results') }}" class="btn btn-outline-secondary py-2">
