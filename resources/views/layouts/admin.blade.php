...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard') - Training Center Part Production</title>
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="{{ route('admin.evaluation.results') }}" class="{{ request()->routeIs('admin.evaluation*') ? 'active' : '' }}">
                    <i class="fas fa-clipboard-list"></i> Hasil Evaluasi
                </a>
            </li>
            <li>
            ...
            <div class="dropdown ms-auto">
                <div class="user-profile" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="user-avatar">
                        @if(auth()->user()->photo)
                            <img src="{{ asset('storage/' . auth()->user()->photo) }}" alt="Admin" class="rounded-circle" width="40" height="40" style="object-fit: cover;">
                        @else
                            <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name ?? 'User') }}&background=C62828&color=fff" alt="Admin" class="rounded-circle" width="40">
                        @endif
                    </div>
                </div>
