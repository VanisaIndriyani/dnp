...
@if(isset($stats))
    ...
    <div class="row mb-4">
        <div class="col-12">
            ...
            <p class="text-muted">Pilih bagian untuk mengelola materi.</p>
        </div>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-3">
            <a href="{{ route('super_admin.materials.index', ['category' => $cat]) }}" class="text-decoration-none">
                <div class="card border-0 shadow-sm h-100 hover-card">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="text-muted small mb-3">Kelola materi untuk bagian {{ ucfirst($cat) }}</p>
...
@else
    ...
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <div>
                <a href="{{ route('super_admin.materials.index') }}" class="text-decoration-none text-muted mb-2 d-inline-block">
            ...
            @can('super_admin')
            <a href="{{ route('super_admin.materials.create', ['category' => $category]) }}" class="btn btn-danger" style="background-color: var(--primary-color);">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted">Belum ada materi yang diupload untuk bagian {{ ucfirst($category) }}.</p>
                    </div>
                </div>
            </div>
        @endforelse
    ...
    <div class="mt-3">
        {{ $materials->appends(['category' => $category])->links() }}
    </div>
@endif
